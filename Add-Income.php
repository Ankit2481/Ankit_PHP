...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into tblincome(UserId,IncomeDate,IncomeSource,IncomeAmount) value('$userid','$dateexpense','$item','$costitem')");
if($query){
...
<head>
	...
	<title>Expenses Mangement System || Add Income</title>
